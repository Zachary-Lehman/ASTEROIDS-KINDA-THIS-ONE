...
/// @DnDVersion : 1
/// @DnDHash : 5E77D96E
/// @DnDArgument : "code" "draw_set_font(fnt_UI);$(13_10)draw_text(200, 50, global.life);$(13_10)draw_text(350, 50, score);$(13_10)draw_text(500, 50, "Homing Missiles:");$(13_10)draw_text(770, 50, global.homing_ammo);$(13_10)draw_healthbar(100, 50, 50, 300, global.charge, c_aqua, c_yellow, c_blue, 0, true, true);$(13_10)if (score >= 5000){$(13_10)if (instance_number(obj_asteroid <= 0)){$(13_10)with (obj_asteroid) instance_destroy();$(13_10)}$(13_10)draw_text(514, 384, "You Beat the First Level!");$(13_10)alarm_set(5, 1);$(13_10)}"
