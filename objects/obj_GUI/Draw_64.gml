...
/// @DnDVersion : 1
/// @DnDHash : 5E77D96E
/// @DnDArgument : "code" "draw_set_font(fnt_gothic);$(13_10)draw_text(200, 50, global.time);$(13_10)draw_text(300, 50, "Score:");$(13_10)draw_text(400, 50, score);$(13_10)draw_text(500, 50, "Homing Missiles:");$(13_10)draw_text(770, 50, global.homing_ammo);$(13_10)if (room = room_level_1){$(13_10)draw_healthbar(100, 50, 50, 300, global.charge, c_aqua, c_yellow, c_blue, 0, true, true);$(13_10)}$(13_10)if (score >= 5000){$(13_10)if (instance_number(obj_asteroid <= 0)){$(13_10)with (obj_asteroid) instance_destroy();$(13_10)}$(13_10)room = room_you_won;$(13_10)score = 0;$(13_10)}$(13_10)"
draw_set_font(fnt_gothic);
draw_text(200, 50, global.time);
draw_text(300, 50, "Score:");
draw_text(400, 50, score);
